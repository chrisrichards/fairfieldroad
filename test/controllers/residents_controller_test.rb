...
class ResidentsControllerTest < ActionController::TestCase
  ...
  test "should create resident" do
    assert_difference('Resident.count') do
      post :create, resident: { email_address: @resident.email_address, house_number: @resident.house_number, road: @resident.road }
    end
  ...
  test "should update resident" do
    patch :update, id: @resident, resident: { email_address: @resident.email_address, house_number: @resident.house_number, road: @resident.road }
    assert_redirected_to resident_path(assigns(:resident))
  end
